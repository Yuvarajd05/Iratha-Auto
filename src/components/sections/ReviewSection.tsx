      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex md:hidden gap-6 mb-16 overflow-x-auto snap-x snap-mandatory scrollbar-hide">
          ...
          {reviews.map((review, index) => (
            <motion.div
              ...
              transition-all duration-500"
            >
              <div className="text-yellow-400 mb-3 tracking-widest">
                ★★★★★
              </div>
        ...
        <div className="border-t border-white/10 pt-12 text-center">
          <div className="flex flex-col md:flex-row justify-center items-center gap-12">
            ...
            <div>
              <h3 className="text-4xl text-[#C6A75E] font-light">2500+</h3>
              <p className="text-white/50 text-xs tracking-wider uppercase">
                Cars Serviced
              </p>
            </div>
            ...
            <div>
              <h3 className="text-4xl text-[#C6A75E] font-light">5+</h3>
              <p className="text-white/50 text-xs tracking-wider uppercase">
                Years Experience
              </p>
            </div>
            ...
            <div>
              <h3 className="text-4xl text-[#C6A75E] font-light">350+</h3>
              <p className="text-white/50 text-xs tracking-wider uppercase">
                Google Reviews
              </p>
            </div>

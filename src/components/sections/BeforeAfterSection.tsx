  ...
  return (
    <section className="w-full py-12 bg-[#0A0A0A]">
      <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          {works.map((work, index) => (
            ...
            >
              ...
              <div
                ...
                style={{ width: `${slider}%` }}
              >
                <img src={work.before} className="w-full h-full object-cover" alt="" />
              </div>
            </div>
          ))}
        ...
        {/* Description */}
        <div className="mt-4">
          <h3 className="text-xl md:text-2xl text-white font-light">{works[activeIndex].car}</h3>

          <p className="text-[#C6A75E] mt-2 tracking-wide">{works[activeIndex].title}</p>
        </div>
